...
public class NurseUserInterfaceController implements Initializable {
    ...
    private boolean submitVisitForm(PatientVisitForm visit) throws SQLException {
        ...
        statement.setString(1, (visit.getValue("physicianName").substring(4)));
    ...
    private boolean checkVisitEmpty() {
        return (visitNameText.getText().equals("") && visitDate.getEditor().getText().equals("") && getHurt().equals("[]") &&
                ...
                visitCheckinDate.getEditor().getText().equals("") && !visitAdmissionYesRadio.isPressed() && visitCheckinDate.getEditor().getText().equals("") &&
                !visitAdmissionNoRadio.isPressed() && visitCheckoutDate.getEditor().getText().equals("") &&
                visitRoomNumberText.getText().equals("") && visitPhysicianChoice.getValue() == null &&
                getMedications().equals("[]") && getInjection().equals("[]") && getPossibleDiagnosis().equals("[]") &&
                visitNotes.getText().equals(""));
    }
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            ...
            ResultSet rs = smt.executeQuery();
            while (rs.next()) {
                primaryPhysicians.add("Dr. " + rs.getString("fullname"));
            }
